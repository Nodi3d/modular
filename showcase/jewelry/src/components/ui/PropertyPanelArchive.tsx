...
export const PropertyPanel: React.FC = () => {
  ...
  useParameterSync(nodeIds.length, length, updateNodeProperty);
  useParameterSync(nodeIds.outerSize, outerSize, updateNodeProperty);
  useParameterSync(nodeIds.tipInnerSize, tipInnerSize, updateNodeProperty);
  useParameterSync(nodeIds.tipOuterSize, tipOuterSize, updateNodeProperty);
  useParameterSync(nodeIds.needleLength, needleLength, updateNodeProperty);
    ...
    <>
      ...
      >
        ...
        <a
          ...
          href={`https://docs.google.com/forms/d/e/1FAIpQLSf5L-INqDqmH0yHtx1aOoFguA1MpkODBXZIua-5Bm2t3KBU6Q/viewform?usp=pp_url&entry.1225353679=${encodeURIComponent(
            length
          )}&entry.11693644=${encodeURIComponent(
            outerSize
          )}&entry.1455151050=${encodeURIComponent(
            tipInnerSize
